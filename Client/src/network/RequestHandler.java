            ...
            try {
                ...
                switch (operationToDo) {
                    case JsonableConst.VALUE_LOGIN:
                        ...
                        //outStream.println(loginUser(LoginResponse));
                        break;
                        case JsonableConst.VALUE_REGISTER:
                            RegisterResponse registerResponse = new Gson().fromJson(jsonResponse, RegisterResponse.class);
                        outStream.println(registerUser(LoginResponse));
                        break;
                    default:
